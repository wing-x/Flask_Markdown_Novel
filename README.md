...
#### タイムライン生成
1. timeline.mdを開いた状態で「タイムライン生成」ボタンをクリック
2. 追加の要望があれば入力（例：「3部構成で、各部に2章ずつ」）
3. Claudeがプロジェクトの設定を参考に詳細なタイムラインを作成
4. 物語開始前の背景、各章の出来事、伏線の配置などが含まれます

#### 世界観設定生成
1. worldbuilding.mdを開いた状態で「世界観設定生成」ボタンをクリック
2. 追加の要望を入力（例：「中世ファンタジー、魔法が存在する世界」）
3. Claudeが詳細な世界観設定を提案
4. 社会体制、地理、歴史、魔法システムなどが含まれます
